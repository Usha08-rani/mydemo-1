...
public class csSEL {
  ...
  public void testregistration() throws InterruptedException {
	 ...
	 driver.findElement(By.xpath("//input[@name='userName']")).sendKeys("usha12");
	 driver.findElement(By.xpath("//input[@name='firstName']")).sendKeys("rani");
	 driver.findElement(By.xpath("//input[@name='lastName']")).sendKeys("usha");
	 ...
	 driver.findElement(By.xpath("//input[@name='emailAddress']")).sendKeys("usha@kmail.com");
	...
	driver.findElement(By.xpath("//input[@name='userName']")).sendKeys("usha123");
	driver.findElement(By.xpath("//input[@name='password']")).sendKeys("abcd1234"); 
